...
LOOP
    -- Determine the day of the week for the current_day
    IF TO_CHAR(current_day.ATTENDANCE_DAY, 'D') IN (2, 4, 6) THEN -- Monday, Wednesday, and Friday
...
BEGIN
  ADD_ATTENDANCE(006479036, 'J0011', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(001538793, 'J0021', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(009714722, 'J0031', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(005837122, 'J0041', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(003278356, 'J0051', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(001201969, 'J0061', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(001885843, 'J0012', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(005621792, 'J0052', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(006374702, 'J0053', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
  ADD_ATTENDANCE(002051359, 'J0062', TO_DATE('2023-11-01', 'YYYY-MM-DD'), TRUNC(SYSDATE));
END;
/